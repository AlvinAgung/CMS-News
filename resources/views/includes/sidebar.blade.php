            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                ...
                <ul class="menu-content">
                    @if ( \Auth::user()->role_id == '1' )
                        ...
                        <li><a class="d-flex align-items-center" href="{{ route('kategori-berita.index') }}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate"
                            data-i18n="List">Kategori</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="{{ route('berita.index') }}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate"
                            data-i18n="List">Berita</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="{{ route('acara.index') }}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate"
                            data-i18n="List">Acara</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="{{ route('video.index') }}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate"
                        ...
                        <li><a class="d-flex align-items-center" href="{{ route('perangkat-desa.index') }}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate"
