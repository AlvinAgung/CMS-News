                            ...
                            <div class="card card-statistics">
                                <div class="card-header">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button type="button" class="btn btn-primary" id="btn-create"><a class="text-white" href="{{route('kategori-berita.create')}}">Tambah Kategori</a></button>
                                    </div>
                                </div>
                                    ...
                                    <table class="dt-responsive table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->name }}</td>
                                                <td>
                                                    <a href="{{route('kategori-berita.show', $item->id)}}"><button class="btn btn-warning"><i class="fa fa-edit"></i></button></a>
