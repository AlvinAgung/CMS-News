                            ...
                            <div class="card card-statistics">
                                <div class="card-header">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button type="button" class="btn btn-primary" id="btn-create"><a class="text-white" href="{{route('berita.create')}}">Add News</a></button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table class="dt-responsive table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('berita.show', $item->id)}}"><button class="btn btn-warning">Update</button></a>
