                        ...
                        <div class="col-xl-12 col-md-12 col-12">
                            <div class="card card-statistics">
                                <div class="card-header">
                                    <h4 class="card-title">Add Acara</h4>
                                </div>
                                <div class="card-body">
                                    <form id="form-create" method="POST" action="{{ route('acara.update',$show->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <input type="datetime-local" id="time" class="form-control @error('time') is-invalid @enderror"
                                                    aria-label="time" aria-describedby="time" name="time" value="{{ $show->time }}">
                                                @error('time')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
